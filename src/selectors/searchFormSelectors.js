...
export const getSelectedFormats = state => getSearchFormState(state).selectedFormats;
...
export const getSelectedSets = state => getSearchFormState(state).selectedSets;
